 ...
 * @author rahul
 * 
 *         It contains all SPE_TRXN_DETAILS_ISRO database fields and its
 *         setters and getters methods it is Model of SPE_TRXN_DETAILS_ISRO table
 */
@Entity
@Table(name = "SPE_TRXN_DETAILS_ISRO")
...
public class SPE_TRXNDetailsISROModel extends SPE_TRXNDetailsModel{
	...
	public SPE_TRXNDetailsISROModel() {
		super();
	...
	public String toString() {
		return "SPE_TRXNDetailsISROModel [getSPE_AutoSrNo()=" + getSPE_AutoSrNo() + ", getSPE_MID()=" + getSPE_MID()
				...
				+ ", getSPE_Option15()=" + getSPE_Option15() + ", toString()=" + super.toString() + ", getClass()="

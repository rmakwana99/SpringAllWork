 ...
 * @author rahul
 * 
 *         It contains all SPE_TRXN_DETAILS_PYHD database fields and its
 *         setter and getter method it is Model of SPE_TRXN_DETAILS_PYHD table
 */

@Entity
@Table(name = "SPE_TRXN_DETAILS_PYHD")
...
public class SPE_TRXNDetailsPYHDModel extends SPE_TRXNDetailsModel {
...
private static final long serialVersionUID = 1L;
	...
	public SPE_TRXNDetailsPYHDModel() {
		super();
	...
	public String toString() {
		return "SPE_TRXNDetailsPYHDModel [SPE_AutoSrNo=" + SPE_AutoSrNo + ", getSPE_MID()=" + getSPE_MID()
				...
				+ ", getSPE_Option15()=" + getSPE_Option15() + "]";
	}
